...
const ITEMS = [
  {
    ...
    title: '商业规划',
    subtitle: '战略 & 愿景',
    description: '综合的市场进入策略，提升品牌定位，实现可持续的市场增长。',
    tags: ['战略', '品牌', '增长'],
    stat: '6+ 方案',
    icon: (
  ...
  },
  {
    ...
    title: '营销规划',
    subtitle: '营销活动 & 策略',
    description: '创新的多渠道营销活动，吸引注意力，改变认知，提升品牌价值。',
    tags: ['数字营销', '活动', '数据分析'],
    stat: '10+ 方案',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    title: '实战营销案例',
    subtitle: '真实案例分析',
    description: '真实的营销活动，真实的成果。记录执行策略、实验和可量化的结果。',
    tags: ['案例研究', '数据', '成果'],
    stat: '17+ 案例',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    title: '编程项目',
    subtitle: '构建 & 工程',
    description: '全栈应用、智能自动化和交互式工具，采用现代框架和执着的工程精神。',
  ...
  },
  {
    ...
    title: '摄影作品',
    subtitle: '光影 & 故事',
    description: '充满张力的画面，捕捉决定性瞬间，讲述镜头后的故事。',
    tags: ['构图', '光影', '故事'],
    stat: '200+ 作品',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    title: '视频编辑',
    subtitle: '动感 & 叙事',
    description: '每一个切割都有目的，每一个过渡都恰到好处，情感驱动节奏。',
    tags: ['动感', '时序', '情感'],
    stat: '30+ 视频',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full p-6 gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[9px] font-bold tracking-[0.24em] mb-2 text-[#191970]/40 dark:text-[#d4af37]/50" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>
              {item.subtitle}
            </p>
            <h2 className="text-[15px] font-bold text-[#111111] dark:text-white leading-tight mb-3 group-hover:text-[#191970] dark:group-hover:text-[#ffd700] transition-colors duration-200" style={{ fontFamily: 'ZCOOL XiaoWei, sans-serif' }}>
              {item.title}
            </h2>
            <p className="text-xs text-[#555555] dark:text-white/40 leading-relaxed line-clamp-3 group-hover:text-[#333333] dark:group-hover:text-white/60 transition-colors duration-200" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>
              {item.description}
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-1.5">
            {item.tags.map((tag) => (
              <span
                key={tag}
                className="text-[9px] font-bold tracking-wider px-2 py-0.5 bg-[#191970]/5 dark:bg-[#d4af37]/8 text-[#191970] dark:text-[#d4af37] border border-[#191970]/10 dark:border-[#d4af37]/15 group-hover:bg-[#191970]/10 dark:group-hover:bg-[#d4af37]/15 transition-colors"
...
function Stat({ n, label, delay }: { n: string; label: string; delay: string }) {
  return (
    <div className="text-center" style={{ opacity: 0, animation: `fadeSlideUp 0.7s cubic-bezier(0.16,1,0.3,1) ${delay} forwards` }}>
      <div className="font-display text-[2.8rem] text-[#ffd700] dark:text-[#d4af37] leading-none drop-shadow-[0_0_12px_rgba(255,215,0,0.4)]" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>{n}</div>
      <div className="text-[9px] tracking-[0.22em] text-white/50 dark:text-white/35 mt-1.5 font-bold" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>{label}</div>
    </div>
  );
}
  ...
  return (
    <>
      <style>{`
        ...
        .font-display { font-family:'ZCOOL XiaoWei',sans-serif; letter-spacing:0.02em; font-weight:400; }
      ...
      <div className="min-h-screen bg-white dark:bg-[#0a0a1a] transition-colors duration-300">
        ...
        <section className="relative min-h-[96vh] flex flex-col justify-center overflow-hidden bg-[#191970] dark:bg-[#0a0a1a]">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 py-28">
            ...
            <div className="anim-0 flex items-center gap-3 mb-7">
              ...
              <span className="text-[10px] font-bold tracking-[0.3em] text-[#ffd700]" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>
                韦燕 · 作品集
              </span>
            </div>
            ...
            <h1 className="anim-1 font-display leading-[0.88] mb-8" style={{ fontSize: 'clamp(3.8rem,11vw,9.5rem)' }}>
              ...
              <span className="block text-white">作品</span>
            ...
            <div className="anim-2 flex flex-col sm:flex-row items-start sm:items-end gap-8 mb-12">
              <p className="text-white/60 text-lg leading-relaxed max-w-md font-light" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>
                六个领域。一种执着：打造{' '}
                <em className="not-italic font-semibold text-white/90">美观高效</em>{' '}
                的作品，留下深刻印象。
              </p>
              <div className="flex gap-8 sm:ml-auto flex-shrink-0">
                <Stat n="6+" label="专业领域" delay="0.75s" />
                <Stat n="50+" label="项目数" delay="0.87s" />
                <Stat n="3" label="语言" delay="0.99s" />
              </div>
            </div>
            ...
            <div className="anim-3 flex flex-wrap items-center gap-4">
              <a
                href="#work"
                className="relative inline-flex items-center gap-2.5 px-8 py-3.5 font-bold text-sm text-[#0f0f45] overflow-hidden cta-ring hover:bg-[#ffe347] transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ffd700]/50 bg-[#ffd700]"
                style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}
              >
                浏览全部作品
              ...
              <Link
                href="/portfolio/marketing-in-motion"
                className="inline-flex items-center gap-2.5 px-8 py-3.5 font-bold text-sm border border-[#ffd700]/40 text-[#ffd700]/85 hover:border-[#ffd700]/70 hover:text-[#ffd700] hover:bg-white/5 transition-all duration-200 focus:outline-none"
                style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}
              >
                推荐作品
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 anim-2">
            ...
            <span className="text-[8px] tracking-[0.32em] text-[#ffd700]/45 font-bold" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>向下滚动</span>
          </div>
        </section>
        ...
        <div className="overflow-hidden border-y border-[#ffd700]/20 bg-[#0f0f45] dark:bg-[#0a0a1a] dark:border-[#d4af37]/10 py-3.5">
          <div className="flex whitespace-nowrap marquee-track select-none">
            {[...MARQUEE, ...MARQUEE].map((t, i) => (
              <span
                key={i}
                className={`inline-flex items-center px-5 text-[10px] font-bold tracking-[0.18em] ${
            ...
            <div className="reveal flex items-end justify-between mb-14">
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-[9px] font-bold tracking-[0.3em] text-[#191970] dark:text-[#d4af37]" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>
                    所有领域
                  </span>
                </div>
              ...
              <p className="hidden sm:block text-xs text-[#555] dark:text-black max-w-[200px] text-right leading-relaxed" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>
                悬停任意卡片。点击了解更多。
              </p>
            </div>
        ...
        <div className="clip-diag bg-[#191970] dark:bg-[#0f0f2e] py-32 relative overflow-hidden">
          ...
          <div className="reveal relative z-10 max-w-3xl mx-auto px-6 text-center">
            <p className="text-[9px] font-bold tracking-[0.35em] text-[#ffd700]/65 mb-5" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>
              准备开始合作？
            </p>
            <h2 className="font-display text-white leading-[0.9] mb-6" style={{ fontSize: 'clamp(2.8rem,8vw,7rem)' }}>
              让我们<br />
              <span className="outline-on-navy">一起创作</span><br />
              非凡之作
            </h2>
            <p className="text-white/45 text-sm leading-relaxed mb-10 max-w-md mx-auto" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>
              无论你需要营销策略、编程解决方案还是创意愿景——让我们一起实现它。
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/contact"
                className="relative inline-flex items-center gap-2.5 px-10 py-3.5 font-bold text-sm text-[#0f0f45] overflow-hidden cta-ring hover:bg-[#ffe347] transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ffd700]/50 bg-[#ffd700]"
                style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}
              >
                联系我
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 px-10 py-3.5 font-bold text-sm border border-[#ffd700]/35 text-[#ffd700]/75 hover:bg-white/5 hover:border-[#ffd700]/60 hover:text-[#ffd700] transition-all duration-200 focus:outline-none"
                style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}
              >
                关于我
              </Link>
        ...
        <footer className="border-t border-[#191970]/8 dark:border-[#d4af37]/8 bg-[#f8f9fa] dark:bg-black/25 py-10">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-bold tracking-[0.22em] text-[#191970]/45 dark:text-white/30" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>
                韦燕工作室
              </span>
            </div>
            <nav className="flex flex-wrap justify-center gap-5" aria-label="Portfolio sections">
              {ITEMS.map((item) => (
                <Link
                  key={item.id}
                  href={item.href}
                  className="text-[10px] font-semibold tracking-wider text-[#555555] dark:text-white/25 hover:text-[#191970] dark:hover:text-[#d4af37] transition-colors duration-200"
                  style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}
                >
                  {item.title}
                </Link>
            ...
            <span className="text-[10px] text-[#666666]/45 dark:text-white/15" style={{ fontFamily: 'ZCOOL QingKe HuangYou, sans-serif' }}>
              © {new Date().getFullYear()} 韦燕
            </span>
          </div>
        </footer>
