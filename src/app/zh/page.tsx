...
const Hero = () => (
  ...
  >
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10 relative w-full">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
            ...
            >
              ...
              />
              <span className="relative z-10 text-white">查看我的作品集</span>
            </Link>
        ...
        >
          ...
          >
            {[
              { label: '营销',  transform: 'translateZ(min(80px, 21vw))',                 delay: '0s'   },
              { label: '策略',  transform: 'rotateY(180deg) translateZ(min(80px, 21vw))', delay: '0.5s' },
              { label: '创意',  transform: 'rotateY(90deg) translateZ(min(80px, 21vw))',  delay: '1s'   },
              { label: '成果',  transform: 'rotateY(-90deg) translateZ(min(80px, 21vw))', delay: '1.5s' },
              { label: '创新',  transform: 'rotateX(90deg) translateZ(min(80px, 21vw))',  delay: '2s'   },
              { label: '卓越',  transform: 'rotateX(-90deg) translateZ(min(80px, 21vw))', delay: '2.5s' },
    ...
    <div className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 animate-bounce">
      <span className="text-xs sm:text-sm" style={{ color: 'var(--text-light)' }}>向下滚动</span>
...
/* ── EXPERTISE ───────────────────────────────── */
const expertiseData = [
  { icon: <FaBullhorn size={48} className="text-[#ffd700] dark:text-[#d4af37]" />, title: '数字营销', description: '制定推动参与度、转化率和品牌知名度的战略营销活动。' },
  { icon: <FaChartLine size={48} className="text-[#ffd700] dark:text-[#d4af37]" />, title: '市场分析', description: '深入研究和分析，识别市场趋势、机会和竞争优势。' },
  { icon: <FaUsers size={48} className="text-[#ffd700] dark:text-[#d4af37]" />, title: '品牌建设', description: '打造引人注目的品牌形象，与目标受众产生共鸣并推动业务增长。' },
  { icon: <FaComments size={48} className="text-[#ffd700] dark:text-[#d4af37]" />, title: '内容策略', description: '开发引人入胜的内容，讲述您的品牌故事并与受众建立联系。' },
];
  ...
  <section className="bg-[#f9f9f9] dark:bg-[#1e1e1e] py-16 sm:py-20 px-4 sm:px-8 relative">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12 sm:mb-16">
        ...
        <p className="text-[#666666] dark:text-[#b0b0b0] text-lg sm:text-xl mt-8 max-w-xl mx-auto">我能提供卓越成果的领域</p>
      </div>
          ...
          <div key={index} style={{ height: '280px', perspective: '1000px' }} className="group">
            <div className="relative w-full h-full transition-transform duration-700 group-hover:[transform:rotateY(180deg)]" style={{ transformStyle: 'preserve-3d' }}>
              ...
              <div className="absolute w-full h-full rounded-lg flex flex-col items-center justify-center p-6 sm:p-8 shadow-md bg-[#191970] dark:bg-gradient-to-br dark:from-[#704700] dark:via-[#a67c00] dark:to-[#d4af37] text-center" style={{ backfaceVisibility: 'hidden', transform: 'rotateY(180deg)' }}>
                ...
                <Link href="/zh/portfolio" className="inline-block px-5 sm:px-6 py-2 bg-[#ffd700] dark:bg-[#191970] text-[#191970] dark:text-[#d4af37] rounded font-bold transition-all duration-300 hover:bg-white hover:-translate-y-1 text-sm">
                  了解更多
                </Link>
              </div>
            </div>
...
const AiShowcase = () => (
  <section className="bg-[#f9f9f9] dark:bg-[#1e1e1e] py-16 sm:py-20 px-4 sm:px-8 relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10 relative">
      <div className="text-center mb-12 sm:mb-16">
        <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-[#191970] dark:text-[#d4af37]">AI 驱动营销</h2>
        <p className="text-lg sm:text-xl text-[#666666] dark:text-[#b0b0b0] max-w-3xl mx-auto">利用人工智能技术，重塑您的营销战略</p>
      </div>
      <div className="flex flex-col lg:flex-row items-center justify-between max-w-[1200px] mx-auto gap-10 lg:gap-12">
        ...
        <div className="w-full lg:flex-1 p-6 sm:p-8 bg-white dark:bg-[#2a2a2a] rounded-xl shadow-xl">
          <h3 className="text-[#191970] dark:text-[#d4af37] text-xl sm:text-[1.8rem] mb-4 font-bold">营销的未来已经到来</h3>
          <p className="text-[#333333] dark:text-[#e0e0e0] mb-6 sm:mb-8 leading-relaxed text-sm sm:text-[1.05rem]">
            我将传统营销专业知识与前沿 AI 工具相结合，创造创新的、数据驱动的策略，带来卓越成果。
          </p>
          <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
            {[
              { icon: <FaRobot className="text-[#191970] dark:text-[#d4af37] text-base sm:text-lg" />, label: 'AI 内容创作' },
              { icon: <FaChartPie className="text-[#191970] dark:text-[#d4af37] text-base sm:text-lg" />, label: '预测分析' },
              { icon: <FaBullseye className="text-[#191970] dark:text-[#d4af37] text-base sm:text-lg" />, label: '受众洞察' },
              { icon: <FaBrain className="text-[#191970] dark:text-[#d4af37] text-base sm:text-lg" />, label: '提示词工程' },
            ].map(({ icon, label }, i) => (
          ...
          <Link href="/zh/portfolio" className="inline-block py-2.5 sm:py-3 px-6 sm:px-8 bg-[#191970] dark:bg-gradient-to-r dark:from-[#704700] dark:via-[#a67c00] dark:to-[#d4af37] text-white dark:text-[#0f0f45] rounded font-bold transition-all duration-300 hover:brightness-110 hover:shadow-lg text-sm sm:text-base">
            查看 AI 营销实例
          </Link>
        </div>
      </div>
  ...
  <section className="bg-white dark:bg-[#121212] py-16 sm:py-20">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-10 sm:mb-12">
        <h2 className="text-3xl sm:text-4xl font-bold text-[#0f0f45] dark:text-[#d4af37]">专业技能</h2>
        <p className="mt-4 text-base sm:text-lg text-[#666666] dark:text-[#b0b0b0]">我已掌握的工具与技术</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
        {[
          { heading: '营销', skills: marketingSkills },
          { heading: '创意', skills: creativeSkills  },
        ].map(({ heading, skills }) => (
          <div key={heading}>
...
/* ── CERTIFICATE PREVIEW ─────────────────────── */
const certificates = [
  { icon: <FaAward size={40} className="text-[#ffd700] dark:text-[#d4af37]" />, title: '数字营销', description: '认证数字营销专业人士' },
  { icon: <FaChartPie size={40} className="text-[#ffd700] dark:text-[#d4af37]" />, title: '数据分析', description: '高级分析认证' },
  { icon: <FaUsersCog size={40} className="text-[#ffd700] dark:text-[#d4af37]" />, title: '商业管理', description: 'ICM 商业管理与行政课程' },
];
  ...
  <section className="relative py-16 sm:py-20 px-4 sm:px-8 bg-white dark:bg-[#121212]">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="text-center mb-10 sm:mb-12">
        ...
        <p className="text-[#666666] dark:text-[#b0b0b0] text-lg sm:text-xl font-medium mt-8">验证我专业能力的资质证书</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
        {certificates.map((cert, index) => (
          <div key={index} className="relative group text-center bg-white dark:bg-[#2a2a2a] border border-[#e0e0e0] dark:border-[#444444] rounded-lg p-6 sm:p-8 shadow-md hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 overflow-hidden" style={{ animation: 'certificateFade 0.6s ease forwards', animationDelay: `${(index + 1) * 0.1}s`, opacity: 0 }}>
            ...
            <Link href="/zh/certificate" className="inline-block text-[#191970] dark:text-[#d4af37] font-semibold transition-all duration-300 relative z-10 py-2 px-4 hover:text-[#ffd700] dark:hover:text-[#f9df85] hover:scale-105 text-sm">
              查看证书 →
            </Link>
          </div>
        ))}
      ...
      <div className="text-center mt-12 sm:mt-16">
        <Link href="/zh/certificate" className="inline-block py-3 px-6 sm:px-8 bg-[#191970] dark:bg-gradient-to-r dark:from-[#704700] dark:via-[#a67c00] dark:to-[#d4af37] text-white dark:text-[#0f0f45] font-bold rounded transition-all duration-400 hover:scale-105 hover:shadow-lg text-sm sm:text-base">
          查看所有证书
        </Link>
      </div>
    </div>
...
const Cta = () => (
  <section className="relative py-16 sm:py-20 overflow-hidden bg-gradient-to-r from-[#191970] via-[#2a2a9a] to-[#ffd700] dark:from-[#191970] dark:via-[#704700] dark:to-[#d4af37]">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
      <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">准备好升级您的营销了吗？</h2>
      <p className="mt-4 text-base sm:text-lg max-w-2xl mx-auto mb-8 leading-relaxed text-white/80">
        让我们探讨如何用我的专业知识帮助实现您的业务目标。
      </p>
      <Link href="/zh/contact" className="inline-flex items-center gap-3 bg-[#191970] text-white font-bold py-3 sm:py-4 px-8 sm:px-10 rounded-lg transition-transform duration-300 hover:scale-105 shadow-lg hover:shadow-xl text-base sm:text-lg">
        <span>立即联系</span>
        <FaArrowRight />
      </Link>
    </div>
