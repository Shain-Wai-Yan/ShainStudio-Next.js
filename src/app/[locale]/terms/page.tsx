...
export async function generateMetadata(props: TermsPageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.shainwaiyan.com${basePath}/terms`,
      languages: {
        en: `https://www.shainwaiyan.com/terms`,
        zh: `https://www.shainwaiyan.com/zh/terms`,
        'x-default': `https://www.shainwaiyan.com/terms`,
      },
    },
  };
}
...
export default async function TermsPage(props: TermsPageProps) {
  ...
  const sections: { title: string; content: string }[] =
    Array.isArray(t.terms.sections) ? t.terms.sections : [];
