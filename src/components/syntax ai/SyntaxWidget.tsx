...
// We use react-icons since it's already in your package.json!
  ...
  return (
    <>
      ...
      <button
        onClick={() => {
          setIsOpen(prev => {
            if (!prev) setIsLoading(false); // prevent re-loading overlay on reopen
            return !prev;
          });
        }}
      ...
      {/* The Iframe Container (Always Rendered for Persistence & Instant Load) */}
      <div 
